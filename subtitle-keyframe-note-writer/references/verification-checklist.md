...
- If the image was newly extracted, was the timestamp selection defensible?
- Is the main chapter image placed immediately after the chapter heading?
- If there is a formula/table/diagram image, is it placed near the related explanation?
...
- Is there a better frame in the same chapter for formulas, tables, charts, maps, or slides?
